...
function preload(){
  ...
  spinerex = loadImage("spinrex.png");
...
function setup() {
 ...
 console.log(message)
  ...
  trex.addAnimation("collided", spinerex);
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    if(keyDown("space")|| touches.length>0 && trex.y >= 164) {
        trex.velocityY = -12;
        jumpSound.play();
        touches=[]
    ...
    //agregar gravedad
    trex.velocityY = trex.velocityY + 0.1234567890
